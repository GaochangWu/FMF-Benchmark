...
# =======================================
_C.MODEL.IMAGE_PATCH_SIZE = 8
_C.MODEL.FRAME_PATCH_SIZE = 2
_C.MODEL.ADDITIONAL_TOKENS = True
_C.MODEL.PETYPE = 'learnable'
_C.MODEL.PRETRAINED = ''
# =======================================
...
_C.TIMESFORMER.PYRAMID_CFGS = None
...
_C.DATA.IMAGE_SIZE = 64
_C.DATA.CURRENT_SECONDS = 120
_C.DATA.CURRENT_PATCH_DIMS = 3
# ==============================
...
# 由于大模型训练对显存的占用量极大，batch size 往往很难设置大的数值，
# 如果我们需要较大的 batch size 则需要使用 global batch size 进行梯度累加，模拟大 batch 的训练效果。
# 详见 https://zhuanlan.zhihu.com/p/652502579
# Global batch size
